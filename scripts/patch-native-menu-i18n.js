...
const TRAY_MESSAGE_TRANSLATIONS = [
  ...
  ["trayMenu.newChat", "New Chat", "新建对话"],
  ...
  ["trayMenu.projectlessThreads", "Chats", "对话"],
];
...
const COMMAND_TITLE_MESSAGE_SPECS = [
  ...
  ["newProjectlessTask", "New standalone chat"],
  ["newThread", "New Task"],
  ["newThread", "New Chat"],
  ...
  ...Array.from({ length: 9 }, (_, index) => [`thread${index + 1}`, `Go to Chat ${index + 1}`]),
  ...
  ["toggleThreadPin", "Pin/unpin chat"],
